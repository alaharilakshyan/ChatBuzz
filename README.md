...
[![Frontend Deployment](https://img.shields.io/badge/Frontend-Vercel-black?logo=vercel&logoColor=white)](https://talk-time-app.vercel.app/)
[![Backend Deployment](https://img.shields.io/badge/Backend-Render-darkblue?logo=render&logoColor=white)](https://chatbuzz-v9am.onrender.com/api/v1/health)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.x-blue?logo=typescript&logoColor=white)](https://www.typescriptlang.org/)
[![Next.js](https://img.shields.io/badge/Next.js-16.2-black?logo=next.js&logoColor=white)](https://nextjs.org/)
[![Playwright](https://img.shields.io/badge/E2E_Tests-Playwright-emerald?logo=playwright&logoColor=white)](https://playwright.dev/)
...
1.  **`/chat`**: Manages real-time typing events, message streams, attachments, and updates inside channels/DMs.
2.  **`/presence`**: Coordinates user status syncs (`online`, `idle`, `offline`, or custom actions like Spotify listening states).
...
*   Configure the environment variables in the **Settings > Environment** tab. *Make sure `CLIENT_URL` is set to your deployed Vercel URL to avoid CORS blocks.*
